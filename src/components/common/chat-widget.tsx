        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 40 }}
              className="fixed bottom-4 right-4 left-4 md:bottom-6 md:right-6 md:left-auto md:w-[380px] z-50 h-[500px] max-h-[80vh] bg-card rounded-2xl shadow-2xl flex flex-col border overflow-hidden"
            >
              ...
              <div ref={listRef} className="flex-1 overflow-y-auto p-4 space-y-2 bg-muted/40">
